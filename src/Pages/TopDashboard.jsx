...
import ForecastChartButton from "../Components/ForecastChartButton";


const DashboardPilot = ({ weather, hourlyForecast, dailyForecast, uvIndex, dewPoint, loading, city, setCity,loadChartData, activeAlerts, setGpsCode}) => {
    ...
    <div>
      <nav className="navbar">
        ...
        <div className="navbar__dropdown">
          <SearchBar setCity={setCity} setGpsCode={setGpsCode}/>
        </div>
          ...
          <>
            <section className="weather-dashboard__overview">
              ...
              <div className="weather-card-hourly">
                <div className="navy-box">
                  ...
                  <ForecastChartButton onClick={loadChartData} />
                </div>
              </div>
            ...
            <section className="runway-conditions">
              ...
              <div className="runway-conditions__container">
                ...
                <div className="runway-conditions__details">
            ...
            <div className="navy-box">
              <h3 className="active-alerts__title">Flight Alerts</h3>
              {activeAlerts.length > 0 ? (
                activeAlerts.map((alert, i) => (
                  <p key={i} className="active-alerts__warning">{alert}</p>
                ))
              ) : (
                <p className="active-alerts__warning">✅ No flight-related alerts at this time.</p>
              )}
              <p className="active-alerts__meta">Region: {city} FIR</p>
            </div>
            </section>
